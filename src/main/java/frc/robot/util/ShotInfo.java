 ...
 */
public record ShotInfo(ShooterParameters shooterParameters, Angle turretAngle, ShotQuality quality) {
        public enum ShotQuality {EXCELLENT, GOOD, POOR, IMPOSSIBLE, UNKNOWN}
