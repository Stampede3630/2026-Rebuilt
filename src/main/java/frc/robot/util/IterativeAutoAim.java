...
public class IterativeAutoAim implements AutoAimer {
    ...
    public ShotInfo get(
      ...
      Function<Distance, Time> tofLookup) {
        ...
        Translation2d targetVel = new Translation2d(-chassisSpeeds.vxMetersPerSecond, -chassisSpeeds.vyMetersPerSecond); 
        for (int i = 0; i < 5; i++) {
        ...
        return new ShotInfo(shotLookup.apply(Meters.of(poseRel.getNorm())), poseRel.getAngle().getMeasure(), ShotQuality.UNKNOWN);
      }
}
